...
export default function BentoGridsPamm() {
  return (
    <div className="dark:bg-black">
      {/* <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 text-gray-800 dark:text-white"> */}
        ...
        <Title title={`Scale Your Brokerage`} desc={`A powerful CRM platform with automation, security, and integrations to help your business grow faster and operate smarter.`} />
